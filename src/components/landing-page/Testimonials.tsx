  ...
  const testimonials = [
    {
      ...
      text: `"JOY IT a transformé nos initiatives de bien-être en entreprise en proposant des animations sur-mesure et un accompagnement attentif.  je recommande vivement JoyIt aux entreprises souhaitant renforcer la cohésion et le moral de leurs collaborateurs."`,
      role: "Responsable RH",
    },
    {
      initials: "TR",
      name: "Thomas Ricotta",
      date: "24 août 2024",
      text: `"Le service de JOY IT est à la fois professionnel et attentionné, avec une organisation sans fausse note du premier contact jusqu’au jour J. je recommande JoyIt à toute entreprise désirant offrir une expérience bien-être clé en main."`,
      role: "Manager d'équipe",
    },
    {
      initials: "FB",
      name: "FAres Benabdallah",
      date: "8 avril 2025",
      text: "La réception a été rapide, toute mon équipe était ravie et nous avons pu partager un bon moment autour de ce panier de fruits. Je recommande vivement JoyIt aux entreprises qui n'ont pas le temps d'organiser ce type d'initiative elles-mêmes.",
      role: "Dirigeant",
    },
  ];
